...
import 'package:flutter/services.dart'; // Voor HapticFeedback
import 'package:provider/provider.dart';
import 'package:intl/intl.dart';
import 'package:shared_preferences/shared_preferences.dart';
import '../data_provider.dart';
import '../widgets/painters.dart'; // Onze nieuwe painters file!

// Deze bestanden maken we in de volgende stap:
...
class _StatsScreenState extends State<StatsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (entries.isNotEmpty) {
      ...
      // ---- TCO BEREKENING (Total Cost of Ownership) ----
      if (entries.length > 1) {
        ...
        if (selectedCar != null) {
          ...
          if (selectedCar.roadTaxFreq == 'quarter') {
             fixedMonthly += (tax / 3); 
          } else {
             fixedMonthly += tax;
          }
